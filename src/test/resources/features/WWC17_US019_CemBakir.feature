Feature: WWC17 US019 As an administrator (admin), I want to have an admin panel to do my administrative work
  and I want to be able to log in to the admin panel with the registered email and password

  @c17
  Scenario:WWC147 TC_01 -> Admin Login Screen Functionality and Visibility Test.
  ...
  Scenario:WWC147 TC_02 -> Admin Login Screen Forgot Password Test.
