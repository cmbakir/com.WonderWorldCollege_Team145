...
public class ParentLoginStepDefinitions {
    ...
    ParentLoginPage parentPageSuleyman=new ParentLoginPage();
    ...
    public void clicks_on_login_button_on_homepage() {
        ReusableMethods.bekle(1);
        parentPageSuleyman.loginButton.click();
        ReusableMethods.bekle(1);
    }
    ...
    public void the_username_and_password_form_on_the_user_login_page_should_be_visible() {
        ReusableMethods.bekle(1);
        Assertions.assertTrue( parentPageSuleyman.loginForm.isDisplayed());
        ReusableMethods.bekle(1);
    }
    ...
    public void the_sign_in_button_on_the_user_login_page_should_be_visible() {
        ReusableMethods.bekle(1);
        Assertions.assertTrue( parentPageSuleyman.signInButton.isDisplayed());
        ReusableMethods.bekle(1);
    ...
    public void the_username_and_password_boxes_should_be_on_the_user_login_page() {
        ReusableMethods.bekle(1);
        Assertions.assertTrue( parentPageSuleyman.passwordBox.isDisplayed());
        ReusableMethods.bekle(1);
        Assertions.assertTrue( parentPageSuleyman.userNameBox.isDisplayed());
        ReusableMethods.bekle(1);
    }
    @Then("The user should be able to close the page.")
    public void the_user_should_be_able_to_close_the_page() {
    ...
    public void user_enters_username() {
        parentPageSuleyman.userNameBox.sendKeys(ConfigReader.getProperty("Parent_username_009"));
        ReusableMethods.bekle(1);
    }
    @Then("User enters password.")
    public void user_enters_password() {
        parentPageSuleyman.passwordBox.sendKeys(ConfigReader.getProperty("Parent_password_009"));
        ReusableMethods.bekle(1);
    }
    @Then("User clicks sign in button.")
    public void user_clicks_sign_in_button() {
        ReusableMethods.bekle(1);
        parentPageSuleyman.signInButton.click();
    }
    ...
    public void user_confirms_login() {
        ...
        parentPageSuleyman.ParentDropdownUserMenu.click();
        ReusableMethods.bekle(1);
        parentPageSuleyman.ParentlogautButton.click();
    }
    ...
    public void user_enters_wrong_username() {
        ...
        parentPageSuleyman.userNameBox.sendKeys(faker.name().username());
    ...
    public void user_sees_warning_message(String expectedErrorText) {
        ...
        String actualErrorText=parentPageSuleyman.ErrorText.getText();
        ReusableMethods.bekle(2);

        Assertions.assertEquals(expectedErrorText,actualErrorText);
        parentPageSuleyman.userNameBox.clear();
        parentPageSuleyman.passwordBox.clear();
    }
    ...
    public void user_enters_wrong_password() {
        Faker faker=new Faker();
        parentPageSuleyman.passwordBox.sendKeys(faker.internet().password());
        ReusableMethods.bekle(2);
    }
    ...
    public void the_user_clicks_on_the_forgot_password_text_on_the_login_page() {
        parentPageSuleyman.forgotButton.click();
    ...
    public void the_user_sees_the_forgot_password_text_on_the_form_on_the_page_that_opens() {
        ...
        String actuelText=parentPageSuleyman.forgotPageText.getText();
