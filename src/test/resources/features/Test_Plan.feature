...
##Feature: WWC18 US038 As an administrator (teacher) I would like to have a page where I can view all my permissions in order to create an online permission record and check the permissions I have used

  @paralel2
  Scenario:WWC65 TC_01 -> US038 Testing the Ability to Create an Online Leave Record as a Teacher User
  ...
  @paralel2
  Scenario:WWC140 TC_02 -> US038 Testing the Ability to Check Leaves as a Teacher User
