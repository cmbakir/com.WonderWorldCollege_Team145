...
Feature:WWC12 US048 Functional Test of the Homework Menu in the Student Panel
  ...
  Scenario: WWC144 TC_02 -> US048  Functional Test of the Daily Assignment Section of Homework Menu
    ...
    Then The user views the column fields on the
...
Feature: WWC42 US050 After logging into the Student Panel as a user, I should be able to access the “Attendance” page and see the Attendance details.
